...
This repo is subject to the 3 SOFUNMEME bounty tokens for the first 100 first time time contributors to help onboard them into the project.
...
mkdir -p ~/opt/zos/
cd ~/opt/zos/
git clone https://github.com/meta-introspector/ai-ml-zk-ops.git 
git clone https://github.com/meta-introspector/solfunmeme.git 
```

first
`bash ./ai-ml-zk-ops/scripts/install/node.sh `
