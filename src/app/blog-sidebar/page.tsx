...
export const metadata: Metadata = {
  title: "Blog Details Page | Free Next.js Template for SOLFUNMEME and SaaS",
  description: "This is Blog Details Page for SOLFUNMEME Nextjs Template",
  // other metadata
};
